...
/**
 * This is the Assignment File, Which needed to be implemented
 **/
...
class OrderManagement {
   public:
    void onData(OrderRequest&& request) {
        ...
        // this method should finally call send method should the order request is
        // eligible for sending to exchange.
        // you are free to decide which thread would execute this function.
    }
    // onData method gets invoked when the exchange sends theresponse back.
